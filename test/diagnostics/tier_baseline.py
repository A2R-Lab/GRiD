...
ROBOTS = [
    ...
    ("h1_2_fixed",     URDF_DIR / "unitree_ros/robots/h1_2_description/h1_2.urdf", False),
    ("h1_2_floating",  URDF_DIR / "unitree_ros/robots/h1_2_description/h1_2.urdf", True),
]
...
SMEM_MACROS = {
    "ID":            "ID_DYNAMIC_SHARED_MEM_BYTES",
    "Minv":          "MINV_DYNAMIC_SHARED_MEM_BYTES",
    "FD":            "FD_DYNAMIC_SHARED_MEM_BYTES",
    "ABA":           "ABA_DYNAMIC_SHARED_MEM_BYTES",
    "CRBA":          "CRBA_DYNAMIC_SHARED_MEM_BYTES",
    "EE_POSE":       "EE_POS_DYNAMIC_SHARED_MEM_BYTES",
    "EE_POSE_GRAD":  "DEE_POS_DYNAMIC_SHARED_MEM_BYTES",
    "EE_POSE_HESS":  "D2EE_POS_DYNAMIC_SHARED_MEM_BYTES",
    "ID_DU":         "ID_DU_DYNAMIC_SHARED_MEM_BYTES",
    "FD_DU":         "FD_DU_DYNAMIC_SHARED_MEM_BYTES",
