...
def gen_lie_group_helpers(self):
    ...
    self.gen_add_code_lines([
        ...
        # the col-major gemv. See grid_integrate_floating_q for the value-path twin.
        ...
        "    if (kk<3) {",
        "        double col[3]={-Jr[3*kk],-Jr[3*kk+1],-Jr[3*kk+2]}; double Sc[9]; grid_so3_skew<double>(col,Sc);  // column kk of col-major Jr",
